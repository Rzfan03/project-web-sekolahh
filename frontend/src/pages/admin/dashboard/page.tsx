...
import { getArticle, getGaleri, getGuru, getJadwal, getKelas, getPengumuman, getAgenda, getPpdb, getSiswa } from '../../../lib/supabase'
...
const cards = [
  ...
  { key: 'agenda', label: 'Agenda', icon: FiClock, bg: 'bg-teal-100', color: 'text-teal-500', link: '/admin/dashboard/agenda', fetcher: getAgenda },
...
export default function DashboardPage() {
  ...
  const chartLabels = ['Artikel', 'Galeri', 'Guru', 'Jadwal', 'Kelas', 'Pengumuman', 'Agenda', 'PPDB', 'Siswa']
  const chartData = chartLabels.map((_, i) => Object.values(stats)[i] || 0)
  const colors = ['#f97316', '#3b82f6', '#10b981', '#8b5cf6', '#f43f5e', '#f59e0b', '#14b8a6', '#06b6d4', '#6366f1']
    ...
    <DashboardLayout>
      <div className="mb-8 overflow-hidden rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 p-6 text-white shadow-lg shadow-orange-500/20">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="font-display text-xl font-bold">Selamat Datang, Admin 👋</h2>

...
const KompetensiKeahlian = () => {
    return (
        <section id="kompetensi" className="scroll-mt-24 bg-white px-6 py-24 dark:bg-stone-900 dark:bg-stone-900">
            <div className="mx-auto max-w-6xl">
                <Reveal>
                    <div className="flex flex-wrap items-end justify-between gap-6">
                        <div className="max-w-2xl">
                            <h2 className="font-display text-3xl font-extrabold tracking-tight text-stone-900 dark:text-stone-100 dark:text-stone-100 sm:text-4xl">
                                Program Keahlian
                            </h2>
                            <p className="mt-3 leading-relaxed text-stone-600 dark:text-stone-300 dark:text-stone-300">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {kompetensiList.map(({ icon: Icon, title, description }, index) => (
                        <Reveal key={title} delay={index * 60}>
                            <Link
                                to="/jurusan"
                                className="group flex h-full flex-col rounded-2xl border border-stone-200 bg-white dark:border-stone-700 dark:bg-stone-800 dark:border-stone-700 dark:bg-stone-800 p-6 shadow-sm transition-shadow hover:shadow-md"
                            >
                                ...
                                <h3 className="font-display mt-4 text-lg font-bold text-stone-900 dark:text-stone-100 dark:text-stone-100">{title}</h3>
                                <p className="mt-2 text-sm leading-relaxed text-stone-600 dark:text-stone-300 dark:text-stone-300">{description}</p>
